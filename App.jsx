  ...
  return (
    <div className="bg-charcoal min-h-screen flex items-center justify-center text-center px-5">
      <div>
        ...
        <Link to="/" className="inline-flex items-center gap-2 px-6 py-3 bg-clay text-cream font-body font-semibold text-sm rounded-sm hover:bg-clay/85 transition-colors">
          Back to Home
        </Link>
      </div>
    </div>
